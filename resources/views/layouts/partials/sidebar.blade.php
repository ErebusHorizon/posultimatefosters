  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="treeview {{  in_array( $request->segment(1), ['sells', 'pos']) ? 'active active-sub' : '' }}" id="tour_step7">
            ...
            <ul class="treeview-menu">
              @can('direct_sell.access')
                <li class="{{ $request->segment(1) == 'sells' && $request->segment(2) == null ? 'active' : '' }}" ><a href="{{action('SellController@index')}}"><i class="fa fa-list"></i>@lang('sale.list_sale')</a></li>
              @endcan
              @can('direct_sell.access')
        ...
        'units', 'categories', 'barcodes', 'invoice-schemes', 'business-location', 'invoice-layouts', 'printers', 'system-settings', 'payment-account']) || in_array($request->segment(2), ['tables', 'modifiers']) ) {{'active active-sub'}} @endif">
