$(document).ready( function(){
    ...
    if($('#tax_report_date_filter').length == 1){
        ...
        $('#tax_report_date_filter').on('cancel.daterangepicker', function(ev, picker) {
            $('#tax_report_date_filter').html('<i class="fa fa-calendar"></i> {{ __("messages.filter_by_date") }}');
        });
        updateTaxReport();
    }
    ...
    if($('#profit_loss_date_filter').length == 1){
        ...
        $('#profit_loss_date_filter').on('cancel.daterangepicker', function(ev, picker) {
            $('#profit_loss_date_filter').html('<i class="fa fa-calendar"></i> {{ __("messages.filter_by_date") }}');
        });
        updateProfitLoss();
    }
    ...
    product_purchase_report = $('table#product_purchase_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'unit_purchase_price', name: 'purchase_lines.purchase_price' }
    ...
    $('#product_purchase_report_form #variation_id, #product_purchase_report_form #location_id, #product_purchase_report_form #supplier_id').change( function(){
    ...
    product_sell_report = $('table#product_sell_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'transaction_date', name: 't.transaction_date'},
            { data: 'unit_sale_price', name: 'transaction_sell_lines.unit_price' }
    ...
    $('#product_sell_report_form #variation_id, #product_sell_report_form #location_id, #product_sell_report_form #customer_id').change( function(){
